...
starting sound of the following word. The learner may rely on common nouns, be/have, and the idea
of one versus more than one.
...
| Q002 | L01 | SINGLE_CHOICE | choose a before dog | 1 | `an dog` |
| Q003 | L01 | TRUE_FALSE | recognize an egg | 1 | `a egg` |
| Q004 | L01 | MULTIPLE_CHOICE | select two sound-safe phrases | 1 | `a apple` |
| Q005 | L01 | FILL_BLANK | supply a before cat | 1 | missing article |
...
| Q012 | L03 | SINGLE_CHOICE | use a for occupation noun | 1 | missing article |
| Q013 | L03 | FILL_BLANK | listen to old before dog | 2 | choosing from noun alone |
| Q014 | L03 | SENTENCE_ORDER | build She has an orange | 1 | misplaced an |
...
The learner demonstrates transfer by choosing correctly for an unfamiliar but transparent A1 noun,
supplying the article in a short sentence, noticing the sound immediately after the article in an
adjective phrase, and correcting both `a apple` and `an dog`. Exception words are excluded from
the mastery decision.
